...
def evaluate_model_families(
    ...
    def candidate(model, family: str, margin_weight: float) -> tuple[ModelFamilyCandidate, list[dict]]:
    ...
    for k in k_values:
        for home in home_advantages:
            ...
            plain_rows.append((row, predictions))
    ...
    for margin_weight in margin_weights:
        for k in k_values:
            for home in home_advantages:
                ...
                score_rows.append((row, predictions))
